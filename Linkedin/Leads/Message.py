...
#Change the messages as you wish, one of them will be randomly picked
messages = [
    "আমাদের একটা লিংকডিন গুরুপ আছে যেখানে শুধু বাংলাদেশী ব্লকচেইন আগ্রহিদের মিটআপ হয় । আপনাকে পড়ের ম্যাসেজে লিংকটা দেব । আপাতত আমেদের ফেসবুক পেজ ভিজিট করুন একটা ধারনা পাওয়ার জন্য ।\nhttps://www.facebook.com/blockchainbd",
    "আমেদের ফেসবুক পেজ ভিজিট করুন একটা ধারনা পাওয়ার জন্য ।আমাদের একটা লিংকডিন গুরুপ আছে যেখানে শুধু বাংলাদেশী ব্লকচেইন আগ্রহিদের মিটআপ হয় । আপনাকে পড়ের ম্যাসেজে লিংকটা দেব ।\nhttps://www.facebook.com/blockchainbd",
    "আপনাকে পড়ের ম্যাসেজে লিংকটা দেব । আমাদের একটা লিংকডিন গুরুপ আছে যেখানে শুধু বাংলাদেশী ব্লকচেইন আগ্রহিদের মিটআপ হয় । আপাতত আমেদের ফেসবুক পেজ ভিজিট করুন একটা ধারনা পাওয়ার জন্য।\nhttps://www.facebook.com/blockchainbd"
]
...
url = "https://www.linkedin.com/sales/lists/people/6714410409836851200"
...
list_to_remove = "Blockchain Connection"

list_to_add = "Blockchain Connection Message"
